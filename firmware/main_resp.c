 ...
 *
 *           This is a simple code example which acts as the responder in a SS TWR distance 
 *           measurement exchange. This application waits for a "poll" message (recording the 
 *           RX time-stamp of the poll) expected from the "SS TWR initiator" example code 
 *           (companion to this application), and then sends a "response" message recording 
 *           its TX time-stamp.
 *
 * @attention
 *
